...
GREY = (130, 130, 130)
RED = (210,43,43)
bg = pg.image.load(f'images/stars_preview.jpg')
...
class LandingPage:
    ...
    alien_one_imgs = [pg.image.load(f'images/ship1_img_{n}.png') for n in range(2)]
    alien_two_imgs = [pg.image.load(f'images/ship2_img_{n}.png') for n in range(2)]
    alien_three_imgs = [pg.image.load(f'images/ship3_img_{n}.png') for n in range(2)]
    ufo_imgs = [pg.transform.rotozoom(pg.image.load(f'images/ufo__{n}.png'), 0, 0.7) for n in range(2)]
    ...
    def __init__(self, game):
        ...
        strings = [('SPACE', WHITE, headingFont), ('INVADERS', RED, subheadingFont),
                ('= 10 PTS', GREY, font), ('= 20 PTS', GREY, font),
                            ('= 40 PTS', GREY, font), ('= 100 PTS', GREY, font),
